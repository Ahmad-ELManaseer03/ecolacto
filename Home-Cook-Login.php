              ...
              alert ("Your request is still pending !")
                ...
                if ($type_id == 3) {
                    ...
                    if ($row['active'] == 1) {
                        ...
                        echo '<script language="JavaScript">
            document.location="./Home_Cook_Dashboard/";
            </script>';

                    } else {

                        echo '<script language="JavaScript">
                    alert ("You account is deactivated !")
                      </script>';
                    }
              ...
              >
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="POST" action="./Home-Cook-Login.php" id="login-form" >
                      <div class="col-12">
                      ...
                      <div class="col-12">
                        <p class="small mb-0">
                          Become New Home-Cooker!
                          <a href="./Home-Cook-Signup.php">Join Us Now!</a>
                        </p>
                      </div>
