                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-item w-100">
                                        <label class="form-label my-3">Rate Store</label>
                                        <div class="w-100 d-flex">
                                        <a href="Rate-Seller.php?Rate=1&seller_id=<?php echo $seller_id; ?>&H_ID=<?php echo $H_ID; ?>" role="button"><i title="1" style="color:#fad00e" class="fa fa-star"></i></a>
                                        <a href="Rate-Seller.php?Rate=2&seller_id=<?php echo $seller_id; ?>&H_ID=<?php echo $H_ID; ?>" role="button"><i title="2" style="color:#fad00e" class="fa fa-star"></i></a>
                                        <a href="Rate-Seller.php?Rate=3&seller_id=<?php echo $seller_id; ?>&H_ID=<?php echo $H_ID; ?>" role="button"><i title="3" style="color:#fad00e" class="fa fa-star"></i></a>
                                        <a href="Rate-Seller.php?Rate=4&seller_id=<?php echo $seller_id; ?>&H_ID=<?php echo $H_ID; ?>" role="button"><i title="4" style="color:#fad00e" class="fa fa-star"></i></a>
                                        <a href="Rate-Seller.php?Rate=5&seller_id=<?php echo $seller_id; ?>&H_ID=<?php echo $H_ID; ?>" role="button"><i title="5" style="color:#fad00e" class="fa fa-star"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
