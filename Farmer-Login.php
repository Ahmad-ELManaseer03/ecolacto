              ...
              alert ("Your request is still pending !")
                ...
                if ($type_id == 2) {
                    ...
                    if ($row['active'] == 1) {
                        ...
                        echo '<script language="JavaScript">
            document.location="Farmer_Dashboard/";
            </script>';
              ...
              >
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="POST" action="./Farmer-Login.php" id="login-form" >
                      <div class="col-12">
                      ...
                      <div class="col-12">
                        <p class="small mb-0">
                          Become New Farmer!
                          <a href="./Farmer-Signup.php">Join Us Now!</a>
                        </p>
                      </div>
