...
<html lang="en">
  <head>
    ...
    <title>Order Items - EcoLacto</title>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
<?php
    $sql1 = mysqli_query($con, "SELECT * from orders WHERE order_id = '$order_id' ORDER BY id DESC");
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        $sql3 = mysqli_query($con, "SELECT * from products WHERE id = '$product_id'");
